...
import Hcategory from "./products/Hcategory";
  ...
  return (
    <>
      {load ? (
        ...
        <>
          <div className="bg-gray-100 p-4 h-[800px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 w-[1000px] h-[1000px]">
                  <div className="flex flex-col gap-4">
                    <img
                      src={active}
                      alt="Product Image"
                      className="w-full rounded-lg object-fill cursor-pointer"
                    />
                      ...
                      {det.pimages.map((img, ind) => {
                        return (
                          <img
                            ...
                            src={img}
                            alt="Product Image"
                            className={`w-24 h-24 cursor-pointer rounded-lg object-cover  ${
          ...
          {det.category && <Hcategory category={det.category} />}
        </>
      )}
    </>
  );
